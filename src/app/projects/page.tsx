...
export const metadata: Metadata = pageMetadata("Projects", "Example metal roof protection scenarios for XNP self-fusing film system review.", "/projects");
...
export default async function ProjectsPage({ searchParams }: Props) {
  ...
  return (
    <>
      <PageHero eyebrow="Projects" title="Metal Roof Protection Application Examples" description="Generic scenarios showing how the system can be framed before real project inspection, specification and warranty review." />
      <Section>
